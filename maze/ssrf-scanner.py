...
banner="""
  ____ ____  ____  _____    ____   ____    _    _   _ _   _ _____ ____  
 / ___/ ___||  _ \|  ___|  / ___| / ___|  / \  | \ | | \ | | ____|  _ \ 
 \___ \___ \| |_) | |_ ____\___ \| |     / _ \ |  \| |  \| |  _| | |_) |
  ___) |__) |  _ <|  _|_____|__) | |___ / ___ \| |\  | |\  | |___|  _ < 
 |____/____/|_| \_\_|      |____/ \____/_/   \_\_| \_|_| \_|_____|_| \_\
...
if args.payload and not re.match(validateHost_regex,args.payload) and not re.match(validateHostIpWithPort_regex,args.payload):
        ...
        sys.exit()
# Creating a set of links that are already saved and presnt just once in the queue
linksVisited=set()
ssrfVul=set()
# Created to avoid noisy output for throw Away List
